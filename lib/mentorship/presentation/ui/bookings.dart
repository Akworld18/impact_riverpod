                  ...
                  child:Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("June 28, Sat - 04:00 PM - 05:00 PM IST",style: AppStyles().mentorTitleColorTextStyle(fontSize: 14),),
                        SizedBox(height: 10),
                        ...
                        Row(
                          ...
                          children: [
                            Text("Cancel",style: AppStyles().cancelColorTextStyle(),),
                            SizedBox(width: 40),
                            Container(
                              height: 40,
                              decoration: BoxDecoration(
                              ...
                              child: Padding(
                                ...
                                child: Center(
                                  child: Text("Join meeting",style:AppStyles().sessionButtonTextStyle(),),
                                ),
                              ),
                            ),
                          ],
